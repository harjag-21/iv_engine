...
// =========================================================
// IV AXI4-Stream Wrapper — Block RAM Baseline
// =========================================================
// Baseline wrapper for Experiment 1:
// Implements the output FIFO buffer using dedicated Block RAM
// (* ram_style = "block" *) and instantiates the BRAM-based
// core iv_top_bram.
// =========================================================
module iv_axis_wrapper_bram (
    input  logic         aclk,
    input  logic         aresetn,
    ...
    assign iv_tid_in = s_axis_tdata[165:160];
    ...
    (* ram_style = "block" *) logic [127:0] fifo_mem [0:FIFO_DEPTH-1];
    logic [5:0]  wr_ptr;
    logic [5:0]  rd_ptr;
    ...
    // -----------------------------------------
    // Instantiate Core BRAM IV Engine
    // -----------------------------------------
    iv_top_bram u_iv_top (
        .clk            (aclk),
        .rst_n          (aresetn),
