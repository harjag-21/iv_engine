...
// =========================================================
// Multi-Core IV Engine Array Wrapper — Block RAM Baseline
// =========================================================
// Controlled architectural baseline for Experiment 1:
// Instantiates NUM_ENGINES parallel Implied Volatility cores
// using Block RAM context and FIFO storage behind round-robin
// ingress demux and egress arbiter.
// =========================================================
module iv_multi_engine_top_bram #(
    ...
    // ---------------------------------------------------------
    // Engine Core Instantiations (Block RAM Baseline)
    // ---------------------------------------------------------
    generate
        for (i = 0; i < NUM_ENGINES; i = i + 1) begin : core_inst_gen
            iv_axis_wrapper_bram u_engine_core (
                .aclk          (aclk),
                .aresetn       (aresetn),
