...
# Top Module    : iv_dual_core_top (2-Core AXI4-Stream Engine Array)
# Clock Target  : 100 MHz (10.000 ns period)
# Throughput    : 200 Million Options / sec
# Mode          : Out-of-Context (Full physical implementation)
#
# Run via:
#   vivado -mode batch -source run_impl_artix7_2core.tcl
# =========================================================

set PART       xc7a200tffg1156-3
set TOP        iv_dual_core_top
set CLK_PERIOD 10.000
set CLK_NAME   aclk
set OUTDIR     impl_results/artix7_2core
...
puts ""
puts "============================================================"
puts "  IMPLEMENTATION COMPLETE: 2-Core Array on Artix-7 -3"
