...
call xvlog --sv --relax -L uvm ^
    ...
    "iv_engine.srcs/sim_1/new/tb_multi_engine_top.sv"

echo "=== Elaborating Design ==="
call xelab -top tb_multi_engine_top -snapshot tb_multi_engine_top_snapshot -debug typical

echo "=== Running Simulation ==="
call xsim tb_multi_engine_top_snapshot -runall
