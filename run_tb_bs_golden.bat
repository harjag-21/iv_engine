...
call xvlog --sv --relax -L uvm ^
    ...
    "iv_engine.srcs/sim_1/new/tb_bs_golden.sv"

echo "=== Elaborating Design ==="
call xelab -top tb_bs_golden -snapshot tb_bs_golden_snapshot -debug typical

echo "=== Running Simulation ==="
call xsim tb_bs_golden_snapshot -runall
