...
draw_elbow(p_start=(98, 44.0), p_c1=(92.0, 44.0), p_c2=(92.0, 16.0), p_end=(78, 16.0),
           ...
           label='Not converged:\n' + r'$\sigma_{n+1} \rightarrow$ Loopback', label_pos=(92.0, 30.0),
...
ax.text(117.5, 37.0, 'Converged: Egress\n' + r'($|C_{\mathrm{BS}}-C_{\mathrm{mkt}}| \leq \epsilon$)', fontsize=7.2, fontweight='bold', color='#2ca02c', va='center')
